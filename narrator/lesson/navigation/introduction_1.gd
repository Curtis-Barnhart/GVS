...
func start() -> void:
    self.text_screen.text = Checkpoint.make_article([
        ...
        [
            ...
            "you have to understand your [color=firebrick]file system[/color] first.",
            "The file system of your computer is where all your files are stored.",
        ],
        [
            "The file system is organized as a [color=firebrick]tree[/color],",
            "which means that, like a tree, it has [color=firebrick]branches[/color].",
            "On a tree, each branch can have [i]more[/i] branches,",
            "and [i]those[/i] branches can have branches, and so on.",
            "In the same way, the file system has [color=firebrick]directories[/color]",
            "(you may also know them by the name 'folders').",
        ],
        [
            "Directories are like the branches on a tree -",
            "they can contain [color=firebrick]leaves[/color]",
            "([color=firebrick]files[/color]) -",
