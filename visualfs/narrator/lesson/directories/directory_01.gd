    ...
    self._text_display.text = UtilString.make_article(
        [
            ...
            [
                ...
                "which is 'file1'.",
                "There are multiple 'file1's on screen, though,",
                "so you need to make sure you click on the 'file1'",
                "that comes after 'directory1',",
                "which is connected to 'directory1' with a blue line and which",
